...
var wpAjaxUrl='http://phillycfo.localhost:4461/wp-admin/admin-ajax.php';var flBuilderUrl='http://phillycfo.localhost:4461/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://phillycfo.localhost:4461/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://phillycfo.localhost:4461/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
$(this.nodeClass+' .fl-send-error').fadeIn();return false;}}};})(jQuery);(function($){$(function(){new FLBuilderContactForm({id:'5f3b35e01c771'});});})(jQuery);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();